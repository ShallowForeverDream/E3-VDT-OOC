...
|---|---:|---:|---:|---:|---:|---:|---:|---|
| best / epoch 1 | 0.3402 | 0.6598 | 0.7398 | **0.7353** | **0.7383** | **0.7096** | **0.7618** | `[[25978,15214],[6048,33997]]` |
| later block | 0.3318 | 0.6682 | 0.7291 | 0.7230 | 0.7273 | 0.6907 | 0.7562 | `[[24733,16459],[5692,34353]]` |
...
当前可汇报的 strict BLIP-2/GaussianBlur VDT baseline：`F1=0.7353`、`Acc=0.7383`、`AUC=0.7398`，target domain 为 `bbc,guardian`。
