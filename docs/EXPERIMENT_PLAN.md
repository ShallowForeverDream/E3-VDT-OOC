...
| VDT strict BLIP-2/GaussianBlur, `target_domain=usa_today,washington_post`, `batch_size=64` | completed | 0.8032 | 0.8032 | 0.8028 | 已完成 13 个 validation blocks；best-by-F1 来自第 9 个 validation block。 |
